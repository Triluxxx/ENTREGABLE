...
import java.util.List;
    ...
    public class UserController {
        ...
        public ResponseEntity<?> crearUsuario(@RequestBody UserEntity user) {
            ...
            if (user.getTipoUsuario() == TypeUser.LABORATORISTA && user.getMedico() == null) {
                LaboratoristaEntity laboratorista = new LaboratoristaEntity();
                laboratorista.setUserEntity(usuarioGuardado); // Asignamos el usuario guardado
                ...
                laboratoristaService.guardar(laboratorista);
            }
